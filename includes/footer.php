...
<div class="footer_container">
    <div class="row">
        ...
        <div class="col-sm-1"><a href="facebook.com/pages/YouCentral/407878222694691?ref=bookmarks"  target="_blank"><img src="img/facebook.png" alt="facebook icon" class="img-responsive footer_icon"></a></div>
